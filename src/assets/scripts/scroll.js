import { delay, addAnimate } from './animation';
import { mobileMenuHandler } from './menu';
...
const advantagesItemsForAnimate = advantages.querySelectorAll('.advantages-animate');
const specificationItemsForAnimate = specification.querySelectorAll('.specification-animate');
const questionsItemsForAnimate = questions.querySelectorAll('.questions-animate');
...
const checkChangeScroll = () => new Promise((resolve) => {
  const scrollChange = setInterval(() => {
